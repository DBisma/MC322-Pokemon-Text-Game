...
public class LowKick extends DmgMisc {
	/*
	 * Move de Fighting que dá dano baseado em peso do adversário.
	 * É semelhante a Grass Knot, mas com só dois moves desse comportamento,
